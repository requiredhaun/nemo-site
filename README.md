...
| Путь | Что делает |
|---|---|
| `/` → `/main` | редирект на главную |
| `/main` | hero, возможности, требования, модалка скачивания |
| `/download` | страница скачивания: Setup / Portable / Source |
| `/politics` | опенсурс, приватность, источники загрузок |
| `/faq` | Java, антивирусы, Ely.by, setup vs portable |
